...
if __name__ == "__main__":
    ...
    dt=0.03125;test_time=500;runtime=2000+test_time
    ...
    model=CustomModel(n_type=AELIF, excit_count=12, inhib_count=0, J=0.5,decay=1.015, stdp_eng=stdp_eng,
    ...
    u_history=[]; i_history=[]; w_his=[]; delay=40
    ...
    # plot_mv_ms(array(i_history), arange(0,runtime, dt), max_x=min_t)
